...
from src.config import API_KEY, CHANNEL_IDS, RAW_DATA_PATH
from src.load_raw_to_s3 import create_s3_bucket, upload_files_to_s3
...
def main():
    ...
    # S3 bucket name and local folder with extracted JSON files
    BUCKET_NAME = "jimbirikandoo-bucket-dontdo"
    LOCAL_FOLDER = "/Users/beprathap/PycharmProjects/youtubeDataset/data/raw"
    ...
    try:
        ...
        print(f"Bucket {BUCKET_NAME} is not accessible: {str(e)}")
        exit(1)
